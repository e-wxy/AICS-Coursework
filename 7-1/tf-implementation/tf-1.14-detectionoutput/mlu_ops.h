...
struct MLUYolov3DetectionOutputOpParam {
  ...
  float* biases_;
  // TODO:构造函数
  MLUYolov3DetectionOutputOpParam(int batchNum, int inputNum, int classNum, 
                                  int maskGroupNum, int maxBoxNum, 
                                  int netw, int neth, 
                                  float confidence_thresh, float nms_thresh, 
                                  int *inputWs, int *inputHs, float *biases):
        batchNum_(batchNum),
        inputNum_(inputNum),
        classNum_(classNum),
        maskGroupNum_(maskGroupNum),
        maxBoxNum_(maxBoxNum),
        netw_(netw),
        neth_(neth),

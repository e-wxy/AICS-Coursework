...
tensorflow::Status CreateYolov3DetectionOutputOp(MLUBaseOp** op, 
    MLUTensor** input_tensors, MLUTensor** output_tensors, 
    cnmlPluginYolov3DetectionOutputOpParam_t param) {
      CNML_RETURN_STATUS(cnmlCreatePluginYolov3DetectionOutputOp(
        op, param, input_tensors, output_tensors));
    }

tensorflow::Status ComputeYolov3DetectionOutputOp(MLUBaseOp* op, 
                                                  MLUCnrtQueue* queue, 
                                                  void* inputs[], 
                                                  int input_num, 
                                                  void* outputs[], 
